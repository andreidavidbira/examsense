...
import { validateUsername, validateRequiredText } from '../../utils/validators'
...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (hasLiveErrors) {
      showToast('Completează corect datele pentru autentificare.', 'error')
      return
    }
    ...
    try {
      ...
      const parsedErrors = getApiErrorMessages(err, 'Autentificare eșuată. Verifică datele introduse.')
      setErrors(parsedErrors)
      showToast('Autentificare eșuată.', 'error')
    } finally {
    ...
    <PageContainer>
      <div className="mx-auto max-w-xl py-8 sm:py-12">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }}>
          <SectionCard
            title="Autentificare"
            subtitle="Intră în contul tău ExamSense+ pentru a continua."
          >
